...
file = chromadb.__file__.replace('__init__.py', 'utils/embedding_functions/open_clip_embedding_function.py')
...
print('Fixed the bug in OpenCLIPEmbeddingFunction class')
