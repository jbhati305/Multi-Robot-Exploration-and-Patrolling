...
def generate_launch_description():
    ...
    robots_known_poses = [
        ...
        # {"name": "robot3", "x_pose": -5.0, "y_pose": 1.5, "z_pose": 0.01},
    ]
    ...
    config_file = os.path.join(launch_dir_map_merge, 'config', 'robot_poses.yaml')
            ...
            spawn_robots_cmds.append(
                Node(
                    ...
                    arguments=[
                        ...
                        robot_sdf,
                        "-robot_namespace",
                        TextSubstitution(text=str(robot["name"])),
                        "-x",
