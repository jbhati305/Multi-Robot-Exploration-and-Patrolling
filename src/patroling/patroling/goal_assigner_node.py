...
class GoalAssignerNode(Node):
    ...
    def __init__(self):
        ...
        self.db_client = EmbeddingClient(os.getenv('DB_URL', 'http://0.0.0.0:8000'))
        ...
        callback_group6 = MutuallyExclusiveCallbackGroup()
        callback_group7 = MutuallyExclusiveCallbackGroup()
        callback_group8 = MutuallyExclusiveCallbackGroup()
        callback_group9 = MutuallyExclusiveCallbackGroup()
        ...
        self.sending_robot = self.create_subscription(String,"/coordinate_data",self.listener_callback,10,callback_group=callback_group2)
        ...
        self.publish_current_points_timer = self.create_timer(2.0, self.publish_current_points, callback_group=callback_group6)
        ...
        self.marker_publish_timer_each = self.create_timer(self.marker_publish_rate_each, self.publish_markers_each, callback_group=callback_group7)
        ...
        # Timer to publish markers periodically
        self.marker_publish_rate = 1.0  # seconds
        self.marker_publish_timer = self.create_timer(self.marker_publish_rate, self.publish_markers, callback_group=callback_group8)
        ...
        self.robot_marker_publish_timer = self.create_timer(self.robot_marker_publish_rate, self.publish_robot_markers,callback_group=callback_group9)
